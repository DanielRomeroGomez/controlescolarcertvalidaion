<nav id="sidebar">
    <div class="sidebar-header">
        <h3><img src="img/logo.png" class="img-fluid" /><span><?php echo $_SESSION['datos_usuario'][2]. ' ' . $_SESSION['datos_usuario'][3] ?></span></h3>
    </div>
    <ul class="list-unstyled components" id="modules">
        <li class="active">
            <a href="#" id="dashboard" class="dashboard"><i class="material-icons">dashboard</i><span>Dashboard</span></a>
        </li>
        <li class="active">
            <a href="#" id="alumnos" class="dashboard"><i class="material-icons">group_add</i><span>Alumnos</span></a>
        </li>
        ...
        <div class="small-screen navbar-display">
            ...
            <li class="d-lg-none d-md-block d-xl-none d-sm-block">
                <a href="#" id="miCuenta"><i class="material-icons">person</i><span>Mi Cuenta</span></a>
            </li>
